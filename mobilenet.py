...
base_model.trainable = False  # congelamos la base al inicio
...
callbacks = [
    ...
    ModelCheckpoint('best_model_mobilenetv2.h5', save_best_only=True, monitor='val_accuracy')
]
...
# =========================================================
# 4. FINE-TUNING (últimas 50 capas de MobileNetV2)
# =========================================================
